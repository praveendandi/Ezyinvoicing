...
def Error_Insert_invoice(data):
	# try:
	# print(data['invoice_object_from_file'],"invoice_object_from_fileinvoice_object_from_fileinvoice_object_from_fileinvoice_object_from_fileinvoice_object_from_fileinvoice_object_from_fileinvoice_object_from_file")
	if "invoice_object_from_file" not in data:
		data['invoice_object_from_file'] = " "
