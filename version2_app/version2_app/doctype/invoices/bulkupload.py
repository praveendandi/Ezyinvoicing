...
def bulkupload(data):
    try:
        ...
        for item in to_dict_data:
            ...
            if invoice_data["company"]=="WMGC-01":
                item[bulk_meta_data["Gst_details"]["invoice_number"]] = "TWM" + str(item[bulk_meta_data["Gst_details"]["invoice_number"]])
            ...
            if invoice_data["company"]=="CBMS-01":
                item[bulk_meta_data["Gst_details"]["invoice_number"]] = "IXBCY-" + str(item[bulk_meta_data["Gst_details"]["invoice_number"]])
        ...
        for each in items_dataframe[bulk_meta_data["detail_folio"]["folio"]][bulk_meta_data["detail_folio"]["invoice_list"]][bulk_meta_data["detail_folio"]["invoice_data"]]:
            ...
            if invoice_data["company"]=="WMGC-01":
                each[bulk_meta_data["detail_folio"]["invoice_number"]] = "TWM" + each[bulk_meta_data["detail_folio"]["invoice_number"]]
            if invoice_data["company"]=="JWMP-01":
            ...
            if isinstance(each[bulk_meta_data["detail_folio"]["list_items"]][bulk_meta_data["detail_folio"]["item_data"]], list):
                for y,x in enumerate(each[bulk_meta_data["detail_folio"]["list_items"]][bulk_meta_data["detail_folio"]["item_data"]]):
                    ...
                    if x[bulk_meta_data["detail_folio"]['transaction_description']].lower() in paymentTypes:# 
                        items_pdf_dict = {'date':item_date,"taxcode_dsc":"No Sac","goods_desc":x[bulk_meta_data["detail_folio"]['transaction_description']],"taxinnum":x[bulk_meta_data["detail_folio"]['taxinnum']],'name':x[bulk_meta_data["detail_folio"]['transaction_description']].split("|")[0],"sac_code":'No Sac'}
                    ...
                    #     x[bulk_meta_data["detail_folio"]["item_value"] = x[bulk_meta_data["detail_folio"]["item_valu_credit"]
                        ...
                        items_dict = {'date':item_date,"goods_desc":x[bulk_meta_data["detail_folio"]['transaction_description']],"taxinnum":x[bulk_meta_data["detail_folio"]['taxinnum']],'name':x[bulk_meta_data["detail_folio"]['transaction_description']].split("|")[0],"taxcode_dsc":"No Sac",'sort_order':int(y)+1,"sac_code":'No Sac'}
