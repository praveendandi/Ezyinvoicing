...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("PPCOMR-01")
        ...
        for i in raw_data:
            ...
            if "Bill  No. " in i:
                ...
                print(invoiceNumber,"invoice_number")
            if "Bill To" in i:
        ...
        company_code = {"code":"PPCOMR-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"PPCOMR-01","invoice_date":date_time_obj}
