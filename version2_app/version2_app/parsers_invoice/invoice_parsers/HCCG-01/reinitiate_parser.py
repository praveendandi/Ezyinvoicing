...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("HCCG-01")
        ...
        for i in raw_data:
            ...
            if "GST ID  :" in i or "GST ID  " in i:
                ...
                gstNumber = gstNumber.replace("INVOICE","").replace("PrintedBy/On","").strip()
        ...
        company_code = {"code":"HCCG-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HCCG-01","invoice_date":date_time_obj}
