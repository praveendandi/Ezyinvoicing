...
def file_parsing(filepath):
    ...
    try:
        ...
        for i in raw_data:
            ...
            if "Confirmation No." in i or "Confirmation No. " in i or "Conf. No. :" in i:
                confirmation_number = i.split(":")
                conf_number = confirmation_number[-1].replace(" ", "")
            if "OriginalBillDate:" in i or "Original Bill Date " in i:
            ...
            if "Guest Tax ID " in i or "GST ID   :" in i:
        ...
        error_data = {"invoice_type": 'B2B' if gstNumber != '' else 'B2C', "invoice_number": invoiceNumber.replace(
            " ", ""), "company_code": "IBISCS-01", "invoice_date": date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "ICS"+invoiceNumber
