...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HRTRI-01")
        ...
        for i in raw_data:
            ...
            if "Departure :" in i:
                date_obj = re.findall("([0-9]{2}\-[A-Z]{3}\-[0-9]{2})+",i)[-1]
        ...
        company_code = {"code":"HRTRI-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HRTRI-01","invoice_date":date_time_obj}
...
#     invoiceNumber = "HRK"+invoiceNumber 
