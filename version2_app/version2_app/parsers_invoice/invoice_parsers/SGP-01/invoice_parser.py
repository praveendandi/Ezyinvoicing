...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("SGP-01")
        ...
        for i in raw_data:
            ...
            if "Guest Tax ID" in i and "Pan No" not in i:
        ...
        company_code = {"code":"SGP-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"SGP-01","invoice_date":date_time_obj}
