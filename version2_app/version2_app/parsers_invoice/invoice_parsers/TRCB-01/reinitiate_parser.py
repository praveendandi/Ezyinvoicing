...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("TRCB-01")
        ...
        for i in raw_data:
            # print(i,"+++++++++++++++")
            if "TAX INVOICE" in i and "COPY OF TAX INVOICE" not in i:
        ...
        company_code = {"code":"TRCB-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TRCB-01","invoice_date":date_time_obj}
