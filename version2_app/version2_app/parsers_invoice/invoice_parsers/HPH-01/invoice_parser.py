...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HPH-01")
        ...
        for i in raw_data:
            ...
            if "TAX INVOICE" in i:
                ...
                print("INV DATEEEEEEEEEEEEEEEE",date_time_obj)
            if "Room No. " in i:
                room = i.split(":")
                roomNumber = room[-1]
            ...
            if "GST ID  " in i:
                ...
                # print(gstNumber,'------------------------')
            # if "GST ID" in i:
            #     gstNumber = i.split(':')[1].replace('COPY OF INVOICE', '')
            #     gstNumber = gstNumber.replace("Confirmation No","").replace("Membership","").strip()
            if "Bill  No." in i:
        ...
        company_code = {"code":"HPH-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HPH-01","invoice_date":date_time_obj}
