...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("RBMIA-01")
        ...
        for i in raw_data:
            ...
            if "Total" in i and "INR" in i and "CP DP Total price" not in i:
        ...
        company_code = {"code":"RBMIA-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RBMIA-01","invoice_date":date_time_obj}
