...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("NOCS-01")
        ...
        for i in raw_data:
            ...
            if "INFORMATION INVOICE" in i:
                return {"message":"INFORMATION INVOICE"}
        ...
        company_code = {"code":"NOCS-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"NOCS-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "NCS"+invoiceNumber
