...
def reinitiateInvoice(data):
    try:
        ...
        for i in raw_data:
            ...
            if "BillDate" in i or "BillDate:" in i:
            ...
            if "Bill  No." in i or "Bill No. " in i:
                ...
                invoiceNumber = invoice_Number.replace("-","").strip()
            if "Bill To" in i:
        ...
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"FAIRMONT-01","invoice_date":date_time_obj}
