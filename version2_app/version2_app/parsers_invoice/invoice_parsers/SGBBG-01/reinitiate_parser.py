...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("SGBBG-01")
        ...
        company_code = {"code":"SGBBG-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"SGBBG-01","invoice_date":date_time_obj}
