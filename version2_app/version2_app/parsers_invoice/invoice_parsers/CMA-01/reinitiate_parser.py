...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("CMA-01")
        ...
        for i in raw_data:
            ...
            if "Hotel GST ID  :" in i:
                ...
                dateobj = raw_data[ind+1].replace("Original Bill","").replace(":","").strip()
            ...
            if "GST ID  :" in i and "Hotel GST ID  " not in i:
                ...
                gstNumber = gstNumber.replace("TAX INVOICE","")
        ...
        company_code = {"code":"CMA-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"CMA-01","invoice_date":date_time_obj}
