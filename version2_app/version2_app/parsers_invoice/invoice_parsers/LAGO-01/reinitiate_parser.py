...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("LAGO-01")
        ...
        for i in raw_data:
            ...
            if "Guest GST ID" in i:
                ...
                gstNumber = gstNumber.replace("PrintedBy/On","").replace("PrintedBy/cOn","")
        ...
        company_code = {"code":"LAGO-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"LAGO-01","invoice_date":date_time_obj}
