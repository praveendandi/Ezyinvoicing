...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("TPI-01")
        ...
        for i in raw_data:
            ...
            if "Bill Generated On Date :" in i:
        ...
        company_code = {"code":"TPI-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TPI-01","invoice_date":date_time_obj}
