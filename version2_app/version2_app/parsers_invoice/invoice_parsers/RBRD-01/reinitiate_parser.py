...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("RBRD-01")
        ...
        for i in raw_data:
            ...
            if "GSTIN ID  " in i:
                ...
                gstNumber = gstNumber.replace("ConfirmationNo","").strip().replace("confirmationNo","")
        ...
        company_code = {"code":"RBRD-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RBRD-01","invoice_date":date_time_obj}
