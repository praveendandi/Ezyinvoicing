...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("GHGurgaon-01")
        ...
        guest['company_code'] = "GHGurgaon-01"
        ...
        company_code = {"code":"GHGurgaon-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"GHGurgaon-01","invoice_date":date_time_obj,"checkout_date":checkout_date if checkout_date != '' else None}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "GRGGH"+invoiceNumber
