...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("IKR-01")
        ...
        for i in raw_data:
            ...
            if "Room No. :" in i or "Room No.  :" in i or "Room No. " in i:
                room = i.split(" ")
                roomNumber = room[-1]
            if  "GST ID   :" in i and "| PAN:" not in i:
        ...
        company_code = {"code":"IKR-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"IKR-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "IKR-"+invoiceNumber
