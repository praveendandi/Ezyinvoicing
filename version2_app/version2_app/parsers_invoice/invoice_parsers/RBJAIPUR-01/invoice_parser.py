...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("RBJAIPUR-01")
        ...
        for i in raw_data:
            ...
            if "GST No" in i and gstNumber =="" and "GST No." not in i :
        ...
        guest['company_code'] = "RBJAIPUR-01"
        ...
        company_code = {"code":"RBJAIPUR-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RBJAIPUR-01","invoice_date":date_time_obj}
