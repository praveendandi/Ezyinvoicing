...
def file_parsing(filepath):
    ...
    try:
        ...
        for i in raw_data:
            ...
            if "Total" in i and "INR" in i and "LTD" not in i:
            ...
            if "GST ID" in i or "GST ID  " in i:
                ...
                gstNumber = gstNumber.replace("TAXINVOICE"," ").replace("TAX_INVOICE","")
                gstNumber = gstNumber.replace("CREDITTAXINVOICE"," ").replace("CREDIT_TAX_INVOICE","")
                gstNumber = gstNumber.replace("CREDITINVOICE"," ").replace("CREDIT_INVOICE","")
                gstNumber = gstNumber.replace("CREDIT","").replace("INVOICE","").strip()
