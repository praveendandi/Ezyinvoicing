...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("TBH-01")
        ...
        for i in raw_data:
            ...
            if "Grand Total:" in i or "Grand Total:" in i:
                i = i.strip()
        ...
        company_code = {"code":"TBH-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TBH-01","invoice_date":date_time_obj}
