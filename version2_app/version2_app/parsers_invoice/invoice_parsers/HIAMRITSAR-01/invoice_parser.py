...
def file_parsing(filepath):
	...
	try:
		...
		companyCheckResponse = check_company_exist("HIAMRITSAR-01")
		...
		for i in raw_data:
			...
			# 	gstNumber = gstNumber.replace("ConfirmationNo","").replace(".","")
		...
		guest['company_code'] = "HIAMRITSAR-01"
		...
		company_code = {"code":"HIAMRITSAR-01"}
		error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HIAMRITSAR-01","invoice_date":date_time_obj}
