...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("TPND-01")
        ...
        for i in raw_data:
            ...
            #     date_time_obj = i.split("Original Bill  :")[1]
            #     date_time_obj = date_time_obj[0:9]
            #     if date_time_obj:
            #         inv_date = datetime.datetime.strptime(date_time_obj.strip(), '%d.%m.%y')
        ...
        company_code = {"code":"TPND-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TPND-01","invoice_date":date_time_obj}
