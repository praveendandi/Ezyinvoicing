...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HRDD-01")
        ...
        for i in raw_data:
            ...
            if "Total" in i and "INR" in i or "Total          INR" in i:
                total_invoice = i.split(" ")
                total_invoice_amount = total_invoice[-2].replace(" ", "")
        ...
        company_code = {"code":"HRDD-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HRDD-01","invoice_date":date_time_obj}
