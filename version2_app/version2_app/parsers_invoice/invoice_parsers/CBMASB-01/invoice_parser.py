...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("CBMASB-01")
        ...
        for i in raw_data:
            ...
            if "Confirmation No  " in i:
                ...
                if "Confirmation No  " in i or "Confirmation No  " in i:
                    confirmation_number = i.split(" ")
                    conf_number = confirmation_number[-1].replace(" ", "")
                    print(conf_number,"confirmation_number")
            if "Total " in i:
        ...
        company_code = {"code":"CBMASB-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"CBMASB-01","invoice_date":date_time_obj}
