...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HRAHMEDABAD-01")
        ...
        for i in raw_data:
            ...
            if "GST ID  " in i:
                gstNumber = i.split(':')[1].replace('PAN No.', '')
                gstNumber = gstNumber.replace("COPY OF INVOICE","")
        ...
        guest['company_code'] = "HRAHMEDABAD-01"
        ...
        company_code = {"code":"HRAHMEDABAD-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HRAHMEDABAD-01","invoice_date":date_time_obj}
