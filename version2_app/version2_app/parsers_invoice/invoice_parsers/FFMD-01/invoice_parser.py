...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("FFMD-01")
        ...
        for i in raw_data:
            ...
            if "Property Tax ID:" in i or "Property Tax ID :" in i:
        ...
        company_code = {"code":"FFMD-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"FFMD-01","invoice_date":date_time_obj}
