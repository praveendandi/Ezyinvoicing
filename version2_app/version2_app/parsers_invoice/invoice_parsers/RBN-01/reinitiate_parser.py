...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("RBN-01")
        ...
        for i in raw_data:
            ...
            if "GSTIN ID  " in i or "GSTIN ID  :" in i:
        ...
        company_code = {"code":"RBN-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RBN-01","invoice_date":date_time_obj}
