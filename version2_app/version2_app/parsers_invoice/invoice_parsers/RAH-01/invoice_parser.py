...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("RAH-01")
        ...
        for i in raw_data:
            ...
            if "Total" in i:
                ...
                total_invoice_amount = float(total_invoice_amount[-2].replace(",", ""))
                print(total_invoice_amount,"total_amount")
            ...
            if "Room  :" in i or "Room :" in i or "Room  " in i:
                room = i.split(":")
        ...
        company_code = {"code":"RAH-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RAH-01","invoice_date":date_time_obj}
