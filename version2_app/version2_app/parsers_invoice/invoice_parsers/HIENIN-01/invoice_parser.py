...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HIENIN-01")
        ...
        for i in raw_data:
            ...
            if "GSTIN / UIN:" in i or "GSTIN/UIN:" in i or "GSTIN / VIN:" in i:
                i = i.replace("GST ","")
        ...
        company_code = {"code":"HIENIN-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HIENIN-01","invoice_date":date_time_obj}
