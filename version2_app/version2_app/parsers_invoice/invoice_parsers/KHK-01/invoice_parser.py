...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("KHK-01")
        ...
        for i in raw_data:
            ...
            if "Company GSTIN  :" in i or "Company GSTIN  " in i:
        ...
        company_code = {"code":"KHK-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"KHK-01","invoice_date":date_time_obj}
...
#     invoiceNumber = "NKHK"+invoiceNumber
