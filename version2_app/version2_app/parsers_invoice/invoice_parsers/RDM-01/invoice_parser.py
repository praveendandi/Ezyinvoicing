...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("RDM-01")
        ...
        for i in raw_data:
            ...
            if "Reservation No." in i:
                confirmation_number = i.split("Visits")
                conf_number = confirmation_number[0].replace("Reservation No.", "").strip()
