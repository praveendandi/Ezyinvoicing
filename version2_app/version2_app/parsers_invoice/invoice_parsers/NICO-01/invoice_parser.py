...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("NICO-01")
        ...
        for i in raw_data:
            ...
            #     index_val=raw_data[raw_data.index(i)-1]
            #     gstNumber = index_val.split(':')[1].replace(' ', '')
        ...
        company_code = {"code":"NICO-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"NICO-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "ICO"+invoiceNumber
