...
def reinitiateInvoice(data):
    try:
        ...
        for i in original_data:
            ...
            if len(check_date) > 0 and "IGST" not in i and "CGST" not in i and "SGST" not in i and "CESS" not in i and "VAT" not in i and "Cess" not in i and "Vat" not in i and "VAT" not in i and "Loyalty No" not in i and "CHEQUE" not in i and "#" not in i: 
                item = dict()
                item_value = ""
                dt = i.strip()
