...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("IBISGGCR-01")
        ...
        for i in raw_data:
            ...
            if "C GST ID" in i or "Guest Tax ID :" in i:
        ...
        guest['company_code'] = "IBISGGCR-01"
        ...
        company_code = {"code":"IBISGGCR-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"IBISGGCR-01","invoice_date":date_time_obj}
