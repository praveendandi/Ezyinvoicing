...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("LAMU-01")
        ...
        for i in raw_data:
            ...
            if "Guest GST ID :" in i  or "Guest GST ID  " in i:
                if "Printed By / On" not in i:
                    ...
                    gstNumber = gstNumber.replace("TAXINVOICE","").replace("Membership","")
                else:
        ...
        company_code = {"code":"LAMU-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"LAMU-01","invoice_date":date_time_obj}
