...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("WGOA-01")
        ...
        for i in raw_data:
            ...
            if "GST ID  " in i:
                ...
                gstNumber = gstNumber.replace("TAXINVOICE", "").replace("CREDITINVOICE","").strip()
            if "Bill  No. " in i:
        ...
        company_code = {"code":"WGOA-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"WGOA-01","invoice_date":date_time_obj}
