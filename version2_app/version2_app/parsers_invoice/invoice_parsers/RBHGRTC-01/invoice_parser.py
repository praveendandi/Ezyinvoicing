...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("RBHGRTC-01")
        ...
        for i in raw_data:
            ...
            if "Original Bill  date " in i :
                ...
                print(date_time_obj,"dateeeeeeeee")
            if "Room No. " in i:
                room = i.split(":")
                roomNumber = room[-1]
            if "GST ID  " in i:
        ...
        company_code = {"code":"RBHGRTC-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RBHGRTC-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "RAFL-"+invoiceNumber
