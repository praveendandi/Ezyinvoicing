...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("PIRS-01")
        ...
        for i in raw_data:
            ...
            if "Bill  No. " in i:
                ...
                invoiceNumber = invoiceNumber.lstrip('-').strip()
            if "Bill To" in i:
        ...
        company_code = {"code":"PIRS-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"PIRS-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "99999-"+invoiceNumber
