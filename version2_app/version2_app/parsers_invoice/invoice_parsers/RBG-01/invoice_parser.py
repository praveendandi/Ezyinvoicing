...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("RBG-01")
        ...
        for i in raw_data:
            ...
            if "Bill" in i and "No." in i or "Bill No." in i:
        ...
        company_code = {"code":"RBG-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RBG-01","invoice_date":date_time_obj}
