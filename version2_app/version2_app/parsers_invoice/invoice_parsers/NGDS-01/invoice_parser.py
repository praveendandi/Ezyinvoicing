...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("NGDS-01")
        ...
        for i in raw_data:
            ...
            if "GST ID" in i:
                ...
                gstNumber = gstNumber.replace("Memlbership","")
        ...
        company_code = {"code":"NGDS-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"NGDS-01","invoice_date":date_time_obj}
