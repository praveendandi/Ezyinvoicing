...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HR-01")
        ...
        for i in raw_data:
            ...
            if "TAX INVOICE" in i or "CREDIT" in i:
        ...
        company_code = {"code":"HR-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HR-01","invoice_date":date_time_obj}
