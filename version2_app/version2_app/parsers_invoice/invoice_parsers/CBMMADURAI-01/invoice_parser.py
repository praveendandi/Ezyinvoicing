...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("CBMMADURAI-01")
        ...
        for i in raw_data:
            ...
            if "Confirmation No " in i or "Confirmation No. " in i:
                ...
                conf_number = ''.join(filter(lambda i: i.isdigit(), conf_number))
        ...
        for index, i in enumerate(guestDeatils):
            if index == 0:
                guest['name'] = i.strip().replace("Room  :","").replace("Room","")
        ...
        guest['company_code'] = "CBMMADURAI-01"
        ...
        company_code = {"code":"CBMMADURAI-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"CBMMADURAI-01","invoice_date":date_time_obj}
