...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HIEBY-01")
        ...
        for i in raw_data:
            ...
            if "Invoice No." in i:
                ...
                if invoiceNumber=="2107-I-YKO0005":
        ...
        company_code = {"code":"HIEBY-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HIEBY-01","invoice_date":date_time_obj}
