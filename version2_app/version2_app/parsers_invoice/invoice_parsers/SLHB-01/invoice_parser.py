...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("SLHB-01")
        ...
        for i in raw_data:
            ...
            if ("GST ID  :" in i or "GST ID :" in i) and "Property Gst ID" not in i:
                ...
                print(gstNumber,len(gstNumber),"gstNumberrrrrrrrrrrrrrrrrrrrrrrrr")
            if "Bill  No." in i:
        ...
        if check_invoice['success']==True:
            ...
            if inv_data.docstatus==2:
                ...
                if inv_data.invoice_type == "B2B":
                    ...
                    reupload = True
        print(invoiceNumber)
        company_code = {"code":"SLHB-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"SLHB-01","invoice_date":date_time_obj}
