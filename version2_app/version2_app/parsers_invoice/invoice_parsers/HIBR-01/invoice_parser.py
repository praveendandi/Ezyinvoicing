        ...
        for i in raw_data:
            ...
            if "Total" in i and "INR" in i:
                ...
                if "-" in total_invoice[-2]:
                    invoice_category = invoice_category = "Credit Invoice"
            if "Bill  No. :" in i:
            ...
            if "GST ID" in i or "GST ID  :" in i and "GST ID-" not in i:
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = invoiceNumber.replace("2720","")
    invoiceNumber = "HIB"+invoiceNumber
