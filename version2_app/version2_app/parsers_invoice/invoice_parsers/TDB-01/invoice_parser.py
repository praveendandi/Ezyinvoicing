...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("TDB-01")
        ...
        if check_invoice['success']==True:
            ...
            if inv_data.docstatus==2:
                ...
                if inv_data.invoice_type == "B2B":
                    ...
                    reupload = True
        company_code = {"code":"TDB-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TDB-01","invoice_date":date_time_obj}
