...
def file_parsing(filepath):
    ...
    try:
        ...
        for i in raw_data:
            ...
            if "Bill Generation Date" in i or "Bill Generation Date  :" in i:
            ...
            if "Room  " in i or "Room  :" in i and "CHECK#" not in i and "Rooms" not in i and "GST" not in i and "Room No" not in i and "Room#" not in i and "NA Room" not in i and "Add: udf." not in i:
                room = i.split(":")
                roomNumber = room[-1]
            ...
            if ("Invoice No" in i or "Invoice No  " in i or "Invoice No ." in i) and "Invoice No:-" not in i:
        ...
        #     if index == 0:
        #         guest['name'] = i.split()[0].strip().lstrip('.')
