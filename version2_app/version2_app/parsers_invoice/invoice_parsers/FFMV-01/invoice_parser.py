...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("FFMV-01")
        ...
        for i in raw_data:
            ...
            if "Room No. :" in i or "Room No" in i and roomNumber=="":
                room = i.split(":")
            ...
            if "Bill  No. :" in i or "Bill  No. " in i:
                ...
                date_time_obj = raw_data[dateind].split(" ")[0].strip()
        ...
        for index, i in enumerate(guestDeatils):
            if index == 0:
                guest['name'] = i.split(':')[1].replace("Bill  No. ","").strip()
        ...
        company_code = {"code":"FFMV-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"FFMV-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "1022-"+invoiceNumber
