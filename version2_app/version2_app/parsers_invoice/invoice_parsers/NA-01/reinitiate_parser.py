...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("NA-01")
        ...
        for i in raw_data:
            ...
            if "Original Bill Date :" in i or "Invoice Date :" in i or "Invoice Date " in i:
        ...
        company_code = {"code":"NA-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"NA-01","invoice_date":date_time_obj}
