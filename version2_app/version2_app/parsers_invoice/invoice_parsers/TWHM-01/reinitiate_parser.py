...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("TWHM-01")
        ...
        company_code = {"code":"TWHM-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TWHM-01","invoice_date":date_time_obj,"checkout_date":checkout_date if checkout_date != '' else None}
