...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("RBGI-01")
        ...
        for i in raw_data:
            ...
            # if ("COPY OF INVOICE" in i or "INVOICE" in i) and "TAX INVOICE" not in i:
            #     dateind = raw_data.index(i)
            #     date_time_obj = raw_data[dateind+1].split(":")[0].replace("Bill  No.","").strip()
            #     print(date_time_obj,"..............")
            #     if ("COPY OF INVOICE" in i or "INVOICE" in i )and "TAX INVOICE" not in i:
            #         date_time_obj = datetime.datetime.strptime(date_time_obj,'%d-%m-%y').strftime('%d-%b-%y %H:%M:%S')
            #     else:
            ...
            if "Bill  No. " in i:
                ...
                print(invoiceNumber,"incccccccccccc")
            if "Bill To" in i:
        ...
        company_code = {"code":"RBGI-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RBGI-01","invoice_date":date_time_obj}
