...
def file_parsing(filepath):
    ...
    try:
        ...
        for i in raw_data:
            ...
            if "Original Bill  :" in i and "Original Bill  da :" not in i:
        ...
        if check_invoice['success']==True:
            ...
            if inv_data.docstatus==2:
                ...
                guest['invoice_number'] = inv_data.invoice_number
            else:
        ...
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TLND-01","invoice_date":date_time_obj,"checkout_date":checkout_date}
