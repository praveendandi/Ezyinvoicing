...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("GHG-01")
        ...
        for i in raw_data:
            ...
            if "GST ID  " in i:
                ...
                gstNumber = i.split(':')[1].replace('COPY OF INVOICE', '').strip()
        ...
        company_code = {"code":"GHG-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"GHG-01","invoice_date":date_time_obj}
