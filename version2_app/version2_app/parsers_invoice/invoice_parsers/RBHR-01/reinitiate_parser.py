...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("RBHR-01")
        ...
        for i in raw_data:
            ...
            if "GST ID  :" in i or "GST ID  " in i:
                ...
                gstNumber = gstNumber.replace("Membership","").strip(".").replace("TAXINVOICE","")
        ...
        company_code = {"code":"RBHR-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"RBHR-01","invoice_date":date_time_obj}
