...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("TWPK-01")
        ...
        company_code = {"code":"TWPK-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TWPK-01","invoice_date":date_time_obj}
