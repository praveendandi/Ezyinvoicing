...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("PPLUDHIANA-01")
        ...
        for i in raw_data:
            ...
            if "Room No" in i:
                room = i.split(" ")
                roomNumber = room[-1]
            if "GST No" in i and "03AAACM9066F1ZM" not in i:
            ...
            #         invoiceNumber = invoiceNumber.rstrip("PPL")
        ...
        guest['company_code'] = "PPLUDHIANA-01"
        ...
        if check_invoice['success']==True:
            ...
            if inv_data.docstatus==2:
                ...
                if inv_data.invoice_type == "B2B":
                    ...
                    reupload = True
        company_code = {"code":"PPLUDHIANA-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"PPLUDHIANA-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "PPL"+invoiceNumber
