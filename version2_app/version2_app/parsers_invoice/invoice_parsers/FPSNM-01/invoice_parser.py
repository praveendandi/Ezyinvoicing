...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("FPSNM-01")
        company = frappe.get_doc("company","FPSNM-01")
        ...
        company_code = {"code":"FPSNM-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"FPSNM-01","invoice_date":date_time_obj}
