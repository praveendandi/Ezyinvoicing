...
def file_parsing(filepath):
    ...
    try:
        ...
        for i in raw_data:
            ...
            if "FSSAI License No " in i or "FSSAI License No" in i or "FSSAI Licence No" in i:
                date_time_obj = i.split(":")[-1].split(" ")[-1]
        ...
        company_code = {"code":"TLPJ-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TLPJ-01","invoice_date":date_time_obj}
