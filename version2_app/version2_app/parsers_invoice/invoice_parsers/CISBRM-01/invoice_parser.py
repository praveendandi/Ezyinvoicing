...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("CISBRM-01")
        ...
        for i in raw_data:
            ...
            if "Original Bill  :" in i:
                date_time_obj = (i.split(":")[-1]).replace("COUNTRY INN","").strip()
        ...
        company_code = {"code":"CISBRM-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"CISBRM-01","invoice_date":date_time_obj}
