...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("ABCBP-01")
        ...
        for i in raw_data:
            ...
            if "Bill  No." in i or "Bill No." in i or "Bill  No. " in i:
                ...
                invoiceNumber = "9999"+invoiceNumber.strip()
            if "Bill To" in i:
        ...
        company_code = {"code":"ABCBP-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"ABCBP-01","invoice_date":date_time_obj}
