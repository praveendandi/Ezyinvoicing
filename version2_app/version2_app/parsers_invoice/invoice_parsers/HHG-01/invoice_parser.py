...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HHG-01")
        ...
        for i in raw_data:
            ...
            if "GST ID  :" in i or "GST ID  " in i:
                ...
                gstNumber = gstNumber.replace("COPY OF INVOICE","").replace("PANNo.","").strip()
        ...
        company_code = {"code":"HHG-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HHG-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    ...
    invoiceNumber = "HYDHY-"+invoiceNumber.strip()
