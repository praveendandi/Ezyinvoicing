...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("MCPH-01")
        ...
        for i in raw_data:
            ...
            if "GST ID" in i and "Property Tax ID" not in i:
        ...
        company_code = {"code":"MCPH-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"MCPH-01","invoice_date":date_time_obj}
