...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("IBISCCC-01")
        ...
        for i in raw_data:
            ...
            if "Bill  No. " in i or "Bill No. " in i:
                ...
                invoiceNumber = invoice_Number.replace("/","-")
            if "Bill To" in i:
                ...
                for index, j in enumerate(i.split(' ')):
                    ...
                    if index == 1:
                        ...
                        if "~" in i:
                            ...
                            item_name = (item["name"].split(" ")[-1]).strip()
                            if len(item_name) == 1:
        ...
        company_code = {"code":"IBISCCC-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"IBISCCC-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "ICBC"+invoiceNumber
