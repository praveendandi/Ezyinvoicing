...
def file_parsing(filepath):
    ...
    try:
        ...
        for ind, each in enumerate(items):
            if "Integrated GST" not in each['name'] and "State GST" not in each['name'] and "Central GST" not in each['name'] and "CGST" not in each["name"] and "SGST" not in each["name"] and "CESS" not in each["name"] and "VAT" not in each["name"] and "Cess" not in each["name"] and "Vat" not in each["name"] and "IGST" not in each["name"]:
