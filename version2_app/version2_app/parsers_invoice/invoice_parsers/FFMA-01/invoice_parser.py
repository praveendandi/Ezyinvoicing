...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("FFMA-01")
        ...
        for i in raw_data:
            ...
            if "GST ID  " in i:
                ...
                gstNumber = gstNumber.replace("CREDIT","").strip()
        ...
        company_code = {"code":"FFMA-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"FFMA-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "0002--"+invoiceNumber.lstrip("0")
