...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("LGPS-01")
        ...
        for i in raw_data:
            if "CREDIT TAX INVOICE" in i or "TAX INVOICE" in i:
                # print(i,"------")
        ...
        company_code = {"code":"LGPS-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"LGPS-01","invoice_date":date_time_obj}
