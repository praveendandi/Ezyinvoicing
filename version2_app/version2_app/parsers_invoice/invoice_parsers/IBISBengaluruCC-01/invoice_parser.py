...
def file_parsing(filepath):
	...
	try:
		...
		companyCheckResponse = check_company_exist("IBISBengaluruCC-01")
		...
		guest['company_code'] = "IBISBengaluruCC-01"
		...
		company_code = {"code":"IBISBengaluruCC-01"}
		error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"IBISBengaluruCC-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "BCC-"+invoiceNumber 
