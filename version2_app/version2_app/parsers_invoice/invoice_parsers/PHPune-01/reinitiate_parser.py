...
def reinitiateInvoice(data):
    try:
        ...
        companyCheckResponse = check_company_exist("PHPune-01")
        ...
        for i in raw_data:
            ...
            if "Total Debit" in i:
                total_invoice = ((i.split(":")[1]).replace("Total Credit","")).strip()
            ...
            if "Bill Date" in i:
                ...
                invoiceNumber = invoiceNumber+"-"+str(date_time)
        ...
        company_code = {"code":"PHPune-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"PHPune-01","invoice_date":date_time_obj}
