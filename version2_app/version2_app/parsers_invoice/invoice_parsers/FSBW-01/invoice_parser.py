...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("FSBW-01")
        ...
        for i in raw_data:
            ...
            if "Total" in i and "Totale" not in i and "PAYMENT" not in i:
        ...
        company_code = {"code":"FSBW-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"FSBW-01","invoice_date":date_time_obj}
