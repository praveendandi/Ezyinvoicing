...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HICHANDIGARH-01")
        ...
        for i in raw_data:
            ...
            # if ("COPY OF INVOICE" in i ) and "TAX INVOICE" not in i :
            #     date_time = raw_data.index(i)+1
            #     date_time_obj = raw_data[date_time]
        ...
        guest['company_code'] = "HICHANDIGARH-01"
        ...
        company_code = {"code":"HICHANDIGARH-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HICHANDIGARH-01","invoice_date":date_time_obj}
