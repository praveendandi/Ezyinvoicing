...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("IBISJ-01")
        ...
        for i in raw_data:
            i = i.strip()
            # print(i,":::::")
            if "Confirmation No." in i or "Conf. No. :" in i:
            ...
            if "GST ID" in i or "GST ID   :" in i:
                ...
                gstNumber = gstNumber.replace("Membership","").replace("Conf.No.","").strip()
                if gstNumber == "na" or gstNumber == "NA" or gstNumber == "N/A":
                    gstNumber = ""
                # gstNumber = gstNumber.replace("NA","")
                # gstNumber = gstNumber.replace("na","")
        ...
        company_code = {"code":"IBISJ-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"IBISJ-01","invoice_date":date_time_obj}
