...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("NSPL-10")
        ...
        for i in raw_data:
            print(i)
            if 'R E G I S T R A T I O N    F O R M' in i:
                redg_card = 'Yes'
            ...
            if "INFORMATION INVOICE" in i or "PRO-FORMA FOLIO" in i:
            ...
            if "Website:" in i:
                ...
                guestDeatils.append(raw_data[ind+2])
                guestDeatils.append(raw_data[ind+3])
            # if "Membership :" in i:
            #     Membership = i.split(":")
        ...
        items = []
        itemsort = 0
        print(redg_card,"hehehehehheheh")
...
def create_doc(file_path, docType, conf_number=""):
    print(file_path)
    company = frappe.get_doc("company","NSPL-10")
    print(conf_number,";;;;;;;")
    if docType == 'Redg Card' and conf_number != "":
        print("//////////")
        doc = frappe.get_doc({
            'doctype': docType,
            'redg_file': file_path,
