    ...
    try:
        ...
        for i in raw_data:
            ...
            if "Conf. No. :" in i or "Conf. No. :":
                ...
                print(conf_number,"conf noooooooooo")
        ...
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"NSPL-10","invoice_date":date_time_obj}
