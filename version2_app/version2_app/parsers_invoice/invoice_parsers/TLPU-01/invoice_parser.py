...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("TLPU-01")
        ...
        for i in raw_data:
            ...
            if "FSSAI License No " in i or "FSSAI License No" in i:
            ...
            if "GSTIN ID  " in i or "GSTIN ID :" in i or "GSTIN ID " in i:
        ...
        company_code = {"code":"TLPU-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"TLPU-01","invoice_date":date_time_obj}
...
def invoiceNumberMethod(invoiceNumber):
    invoiceNumber = "SU-"+invoiceNumber
