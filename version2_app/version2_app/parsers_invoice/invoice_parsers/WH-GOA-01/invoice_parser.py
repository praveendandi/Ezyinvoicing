...
def file_parsing(filepath):
    ...
    try:
        ...
        # information_invoice=False
        for i in raw_data:
            print(i,"/////////////")
            global information_invoice
            if "INFORMATION INVOICE" in i:
                information_invoice=True
                break
            else:
                information_invoice=False
            if "TAX INVOICE" in i:
            ...
            if "Original Bill :" in i or "Original Bill  :" in i or "Original Bill  :" in i:
