...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("GMM-01")
        ...
        for i in raw_data:
            ...
            if "GuestGST ID  :" in i or "GST ID  :" in i:
            ...
            if i in "Date Description Reference Debit Credit" or i.strip() in 'Date  Description  Reference  Debit  Credit' or i.strip() in 'Date  Description  Reference  Debit  Credit':
                entered = True
            if 'CGST 6%=' in i:
                entered = False
            if 'Billing' in i:
        ...
        company_code = {"code":"GMM-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"GMM-01","invoice_date":date_time_obj}
