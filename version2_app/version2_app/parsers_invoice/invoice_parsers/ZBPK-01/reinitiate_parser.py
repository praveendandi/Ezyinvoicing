...
def reinitiateInvoice(data):
    try:
        ...
        print(banquet, taxinvoice, laundary , posbill,B2B_pos)       
        if banquet:
            for i in raw_data:
                # print(i,"++++++++++++++")
                ...
                # if "Total Amount with Taxes" in i or "Net. Amount" in i:
                #     total_invoice_amount=i.split(" ")
        ...
        if taxinvoice:
            for i in raw_data:
                ...
                if "Reg No :" in i:
                    confirmation_number = i.split(":")
                    conf_number = confirmation_number[-1].replace(" ", "")
                if "Net Amount:" in i or "Net Amount :" in i or "Net Amount: " in i:
                    total_invoice = i.split()
