...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("HIESJ-01")
        ...
        for i in raw_data:
            # print(i,"++++++")
            if "Conf. No." in i or "Conf.  No." in i or "Conf.  No." in i:
        ...
        company_code = {"code":"HIESJ-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"HIESJ-01","invoice_date":date_time_obj}
