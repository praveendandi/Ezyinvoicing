...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("LAAB-01")
        ...
        for i in data:
            ...
            if len(check_date) > 0:
                ...
                for index, j in enumerate(i.split(' ')):
                    ...
                    if len(val)>1:
                        item_value = val[-1]
                        item_value = re.findall('[0-9\ ,.]',item_value)
        ...
        company_code = {"code":"LAAB-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"LAAB-01","invoice_date":date_time_obj}
