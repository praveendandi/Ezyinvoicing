...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("RDV-01")
...
def create_doc(file_path, docType, conf_number=""):
    print(file_path)
    company = frappe.get_doc("company","RDV-01")
