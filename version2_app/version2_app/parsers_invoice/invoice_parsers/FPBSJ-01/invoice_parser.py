...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("FPBSJ-01")
        ...
        for i in raw_data:
            ...
            if "GST ID  " in i or "GST ID  :" in i:
                ...
                gstNumber = gstNumber.replace("BillDate","").strip()
        ...
        company_code = {"code":"FPBSJ-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"FPBSJ-01","invoice_date":date_time_obj}
