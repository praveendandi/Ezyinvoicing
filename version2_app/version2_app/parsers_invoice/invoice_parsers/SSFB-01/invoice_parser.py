...
def file_parsing(filepath):
    ...
    try:
        ...
        companyCheckResponse = check_company_exist("SSFB-01")
        ...
        if check_invoice['success']==True:
            ...
            if inv_data.docstatus==2:
                ...
                if inv_data.invoice_type == "B2B":
                    ...
                    reupload = True
        print(invoiceNumber)
        company_code = {"code":"SSFB-01"}
        error_data = {"invoice_type":'B2B' if gstNumber != '' else 'B2C',"invoice_number":invoiceNumber.replace(" ",""),"company_code":"SSFB-01","invoice_date":date_time_obj}
