...
BACKEND_GIT_URL=https://jenkins:s4bjcbgx2qx5ml6hm5grf4pfvdketouweaszld4rcn5jcskzr56q@dev.azure.com/caratred/EzyInvoicing/_git/Ezyinvoice_Backend.git
PARSERS_GIT_URL=https://jenkins:43pbchxovkfvqdnjddnmu7zyrzuzy5chhk6u75jsm7ri5o2wkzbq@dev.azure.com/caratred/EzyInvoicing/_git/invoice_parsers
FRONTEND_GIT_URL=https://jenkins:tz2slctvugswjuupx6qcaweimsmyelbwafg4mmvm2svoa7spqzfq@dev.azure.com/caratred/EzyInvoicing/_git/ezy-invoice-production.git
SYNC_GIT_URL=https://jenkins:xhio2njrd7nfvnmqm4ax66ly24a36b7uiypulqjbftxzoh2kha5a@dev.azure.com/caratred/EzyInvoicing/_git/invoice-sync.git
